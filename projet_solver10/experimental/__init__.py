...
automatically, so importing ``projet_solver10`` never requires the optional
``physics-tenpy`` dependency. Import the required experimental module
explicitly when using one of these features.
"""
