...
from .pathways import (
    configure_standard_2d_pathways_with_ufss as build_standard_2d_pathways_with_ufss,
    default_frequency_pathways,
...
from .protocols import standard_1q_protocol
...
class LiouvilleSpectroscopySolver:
    ...
    def __init__(self, params):
        ...
        self.pathways = default_frequency_pathways()
    ...
    def configure_standard_2d_pathways_with_ufss(self, *args, **kwargs):
        pathways = build_standard_2d_pathways_with_ufss(*args, **kwargs)
        self.set_pathways(pathways)
        return pathways
    ...
    def _using_default_pathways(self):
            ...
            return self.pathways == default_frequency_pathways()
    ...
    def _make_w3_blocks(self, n_w, n_jobs, block_size):
            return make_w3_blocks(
                n_w, n_jobs, block_size, self.parallel_block_size
            )

    def _parallel_context(self, blas_threads):
            return parallel_context(blas_threads, self.blas_threads)
    ...
    def generate_2D_spectra(
            ...
            if (
                ...
                and self._backend.supports_default_2d_fast_path(self.pathways)
                and (
                parallel_backend in {"serial", "threading", None} or n_jobs_eff == 1
                )
            ):
                with self._parallel_context(blas_threads):
                    return self._backend.generate_default_2d(
                        w_list,
                        tau2,
                        integration_weights,
                        spectrum_components,
